                            ...
                            <ul>
                                ...
                                <li class="onclick-title">
                                    ...
                                    <ul class="onclick-content">
                                        ...
                                        <li>
                                            <div class="form-check ps-0 custome-form-check">
                                                <input class="checkbox_animated check-it" type="checkbox" id="flexCheckDefault">
                                                <label class="form-check-label" for="flexCheckDefault">Kerudung</label>
                                            </div>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="onclick-title">
                                    ...
                                    <ul class="onclick-content">
                                        <li>
                                            <div class="form-check ps-0 custome-form-check">
                                                <input class="checkbox_animated check-it" type="checkbox" id="flexCheckDefault12">
                                                <label class="form-check-label" for="flexCheckDefault12">Katun</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check ps-0 custome-form-check">
                                                <input class="checkbox_animated check-it" type="checkbox" id="flexCheckDefault13">
                                                <label class="form-check-label" for="flexCheckDefault13">Sutra</label>
                                            </div>
                                        </li>
                                    </ul>
                                </li>
                                    ...
                                    <ul class="onclick-content">
                                        <li>
                                            <div class="form-check ps-0 custome-form-check">
                                                ...
                                                <label class="form-check-label" for="flexCheckDefault19">Rp0 - Rp500,000</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check ps-0 custome-form-check">
                                                <input class="checkbox_animated check-it" type="checkbox" id="flexCheckDefault20">
                                                <label class="form-check-label" for="flexCheckDefault20">Rp500,000 - Rp1,000,000</label>
                                            </div>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="onclick-title">
                                    ...
                                    <ul class="onclick-content">
                                        <li class="dropdown-list">
                                            <div class="form-check ps-0 custome-form-check">
                                                <input class="checkbox_animated check-it" type="checkbox" id="flexCheckDefault33">
                                                <label class="form-check-label" for="flexCheckDefault33">Paling Sesuai</label>
                                            </div>
                                        </li>
                                        <li class="dropdown-list">
                                            <div class="form-check ps-0 custome-form-check">
                                                <input class="checkbox_animated check-it" type="checkbox" id="flexCheckDefault34">
                                                <label class="form-check-label" for="flexCheckDefault34">Ulasan</label>
                                            </div>
                                        </li>
                                        <li class="dropdown-list">
                                            <div class="form-check ps-0 custome-form-check">
                                                <input class="checkbox_animated check-it" type="checkbox" id="flexCheckDefault35">
                                                <label class="form-check-label" for="flexCheckDefault35">Terbaru</label>
                                            </div>
                                        </li>
                                        <li class="dropdown-list">
                                            <div class="form-check ps-0 custome-form-check">
                                                <input class="checkbox_animated check-it" type="checkbox" id="flexCheckDefault36">
                                                <label class="form-check-label" for="flexCheckDefault36">Harga Terendah</label>
                                            </div>
                                        </li>
                                        <li class="dropdown-list">
                                            <div class="form-check ps-0 custome-form-check">
                                                <input class="checkbox_animated check-it" type="checkbox" id="flexCheckDefault37">
                                                <label class="form-check-label" for="flexCheckDefault37">Harga
                                                    tertinggi</label>
                                            </div>
                                        </li>
                                    </ul>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        <ul class="short-name">
                            ...
                            <li>
                                <div class="label-tag">
                                    <a href="javascript:void(0)"><span>Hapus Semua</span></a>
                                </div>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="filter-options">
                            <div class="select-options">
                                <div class="page-view-filter">
                                    <div class="dropdown select-featured">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li>
                                                <a class="dropdown-item" href="javascript:void(0)">Huruf
                                                    A-Z</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="javascript:void(0)">Huruf
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="javascript:void(0)">Harga, Tinggi ke Rendah</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="javascript:void(0)">Harga, Rendah ke Tinggi</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="javascript:void(0)">Tanggal, Lama ke Terbaru</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="javascript:void(0)">Tanggal, Terbaru ke Lama</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="dropdown select-featured">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0)">Kemeja Wanita</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0)">Kerudung</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0)">Ciput</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0)">Blus</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="grid-options d-sm-inline-block d-none">
                                <ul class="d-flex">
                                    ...
                                    <li class="five-grid active d-xl-inline-block d-none">
                                        <a href="javascript:void(0)">
                                            <img src="../assets/svg/grid-5.svg" class="img-fluid blur-up lazyload" alt="">
                                        </a>
                                    </li>
                                    <li class="list-btn">
                                        <a href="javascript:void(0)">
                            ...
                            <div class="product-details">
                                ...
                                <div class="main-price">
                                    ...
                                    <div class="listing-content">
                                        <span class="font-light">Kemeja</span>
...
<!-- Mirrored from themes.pixelstrap.com/voxo/front-end/shop-top-filter.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Jan 2023 16:02:43 GMT -->
