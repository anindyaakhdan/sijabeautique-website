...
<section class="breadcrumb-section section-b-space">
    ...
    <section class="search-section">
        <div class="container">
            ...
            <div class="search-full open show">
                                    ...
                                    <ul class="custom-scroll">
                                        <li>
                                            <div class="product-cart media">
                                                <img src="assets/images/fashion/product/front/2.jpg" class="img-fluid blur-up lazyloaded" alt="">
                                        ...
                                        <li>
                                            <div class="product-cart media">
                                                <img src="assets/images/fashion/product/front/1.jpg" class="img-fluid blur-up lazyloaded" alt="">
                                                <div class="media-body">
                                                    <a href="javascript:void(0)">
            ...
            <div class="product-wrapper product-style-2 slide-4 p-0 light-arrow bottom-space">
                ...
                <div>
                    <div class="product-box">
                        ...
                        <div class="product-details">
                            <div class="rating-details">
                                <span class="font-light grid-content">Kerudung</span>
                                <ul class="rating mt-0">
                                    <li>
                                        <i class="fas fa-star theme-color"></i>
                                    </li>
                            ...
                            <div class="main-price">
                                ...
                                <h3 class="theme-color">Rp800,000</h3>
                                <button onclick="location.href = 'cart.html';" class="btn listing-content">Masukan Keranjang</button>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <div class="product-box">
                        ...
                        <div class="product-details">
                            <div class="rating-details">
                                <span class="font-light grid-content">Gaun Muslim</span>
                                <ul class="rating mt-0">
                                    <li>
                                        <i class="fas fa-star theme-color"></i>
                                    </li>
                            ...
                            <div class="main-price">
                                ...
                                <h3 class="theme-color">Rp400,000</h3>
                                <button onclick="location.href = 'cart.html';" class="btn listing-content">Masukan Keranjang</button>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <div class="product-box">
                        ...
                        <div class="product-details">
                            <div class="rating-details">
                                <span class="font-light grid-content">Ciput</span>
                                <ul class="rating mt-0">
                                    <li>
                                        <i class="fas fa-star theme-color"></i>
                                    </li>
                            ...
                            <div class="main-price">
                                ...
                                <h3 class="theme-color">Rp690.000</h3>
                                <button onclick="location.href = 'cart.html';" class="btn listing-content">Masukan Keranjang</button>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from themes.pixelstrap.com/voxo/front-end/search.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Jan 2023 16:03:04 GMT -->
</html>