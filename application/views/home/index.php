                ...
                <div class="home-slider">
                    <div class="home-wrap row m-0">
                            ...
                            <div class="home-left-wrapper">
                                <div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <h6 class="text-light">( 540 Ulasan )</h6>
                                    </div>

                                    <p>Misa Blouse koleksi Karkhaa Indonesia.</p>
                                    <h3>Rp. 219.750</h3>
                                    ...
                                    <div class="add-btn">
                                        <a href="<?php echo base_url('wishlist/') ?>" class="btn btn-white">Masukan ke Keranjang</a>
                        ...
                        <div class="col-xxl-9 col-lg-8 p-0 left-content">
                            <img src="assets/images/fashion/slider/1.png" class="bg-img blur-up lazyload" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row gy-4">
            <div class="col-lg-4 col-md-6">
                <div class="collection-banner p-bottom p-center text-center">
                    <a href="<?php echo base_url('shop/') ?>" class="banner-img">
                    ...
                    <a href="<?php echo base_url('shop/') ?>" class="contain-banner">
                        <div class="banner-content with-big">
                            <h2 class="mb-2">Model Terbaru</h2>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="collection-banner p-bottom p-center text-center">
                    ...
                    <a href="<?php echo base_url('shop/') ?>" class="contain-banner">
                        <div class="banner-content with-big">
                            <h2 class="mb-2">Celana Wanita</h2>
                            <span>Potongan 50% off</span>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <div class="row m-0">
            <div class="col-sm-12 p-0">
                <div class="title title-2 text-center">
                    ...
                    <h5 class="text-color">Koleksi Kami</h5>
                </div>
                            ...
                            <div class="img-wrapper">
                                ...
                                <div class="cart-wrap">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="<?php echo base_url('notfound/error404') ?>">
                            ...
                            <div class="product-details">
                                ...
                                <div class="main-price">
                                    <a href="<?php echo base_url('produk/') ?>" class="font-default">
                                        <h5>Kaftan Alicia Broken White Cerutty Premium by Caftanesia</h5>
                                    </a>
                                    ...
                                    <h3 class="theme-color">Rp700,000</h3>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="title title-2 text-center">
                    <h2>Kategori</h2>
                    <h5 class="text-color">Dari Koleksi Kami</h5>
                </div>
            </div>
        </div>
        <div class="row gy-3">
            <div class="col-xxl-2 col-lg-3">
                <div class="category-wrap category-padding category-block theme-bg-color">
                    <div>
                        <h2 class="light-text">Terbaru</h2>
                        <h2 class="top-spacing">Kategori</h2>
                        <span>Teratas</span>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col">
                <div class="title title-2 text-center">
                    ...
                    <h5 class="text-color">Hanya untuk kamu</h5>
                </div>
            </div>
        </div>
        <div class="row gy-4">
                ...
                <div class="collection-banner p-right text-right">
                    ...
                    <div class="banner-text">
                        <div class="banner-content">
                            <span class="span-top">Koleksi <span class="theme-color">Terbaru</span></span>
                            <h2> Kerudung segi empat hanya <span class="theme-color">Rp80,000</span></h2>
                            <button onclick="location.href = '<?php echo base_url('produk/') ?>';" type="button" class="btn btn-solid-default">Belanja Sekarang</button>
                ...
                <div class="row gy-4">
                    <div class="col-lg-12 ratio_40">
                        <div class="collection-banner p-left banner-title">
                            ...
                            <div class="banner-text">
                                <div class="banner-content">
                                    <h3 class="h-bottom">Celana kekinian hanya <span class="theme-color">Rp200,000</span></h3>
                                    <button onclick="location.href = '<?php echo base_url('produk/') ?>';" type="button" class="btn btn-solid-default">Belanja Sekarang</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 ratio2_3">
                        <div class="collection-banner p-center text-center">
                            <a href="<?php echo base_url('shop/') ?>" class="banner-img">
                                <img src="assets/images/fashion/banner/6.jpg" class="bg-img blur-up lazyload" alt="">
                            </a>
                            <a href="<?php echo base_url('shop/') ?>" class="contain-banner">
                                <div class="banner-content with-bg">
                                    <h3 class="mb-1">Kerudung Terbaru</h3>
                    ...
                    <div class="col-sm-6 ratio2_3">
                        <div class="collection-banner p-center text-center">
                            <a href="<?php echo base_url('shop/') ?>" class="banner-img">
                                <img src="assets/images/fashion/banner/7.jpg" class="bg-img blur-up lazyload" alt="">
                            </a>
                            <a href="<?php echo base_url('shop/') ?>" class="contain-banner">
                                <div class="banner-content with-bg">
                                    <h3 class="mb-1">Kemeja Terbaru</h3>
                                    <span>Discount -70%</span>
                                </div>
                            </a>
                        </div>
                ...
                <div class="product-wrapper product-style-2 row g-sm-4 g-3">
                    <div class="col-xl-3 col-lg-4 col-6">
                        <div class="product-box">
                            ...
                            <div class="product-details">
                                <div class="rating-details">
                                    <span class="font-light grid-content">Kemeja</span>
                                    <ul class="rating mt-0">
                                        <li>
                                            <i class="fas fa-star theme-color"></i>
                                        </li>
                                ...
                                <div class="main-price">
                                    ...
                                    <h3 class="theme-color">Rp10,000</h3>
                                    <button onclick="location.href = 'cart.html';" class="btn listing-content">Masukan Keranjang</button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="discount-image-details discount-spacing">
                    ...
                    <div class="discunt-details">
                        <div>
                            ...
                            <h5 class="mt-3">Diskon Spesial <span class="theme-color">70% OFF</span></h5>
                            <h2 class="my-3 deal-text">Khusus hari ini <br>Hanya <span class="theme-color">$Rp100,000</span>
                            </h2>
                            <div class="timer-style-2 mt-xl-1 my-2 justify-content-center d-flex">
                                <ul>
                                    <li>
                                        <div class="counter">
                                            <div>
                                                <h2 id="days1" class="theme-color"></h2>Hari
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="counter">
                                            <div>
                                                <h2 id="hours1" class="theme-color"></h2>Jam
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="counter">
                                            <div>
                                                <h2 id="minutes1" class="theme-color"></h2>Menit
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="counter">
                                            <div>
                                                <h2 id="seconds1" class="theme-color"></h2>Detik
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            <button onclick="location.href = '<?php echo base_url('produk/') ?>';" type="button" class="btn default-light-theme default-theme mt-2">Belanja Sekarang</button>

                            <div class="timer-bg timer-bg-center d-lg-block d-none">
                                <h3 class="mt-0">Blush Terbaru</h3>
                                <span>BUY ONE GET ONE</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-product">
                            ...
                            <div class="modal-contain-details">
                                ...
                                <div class="shop-cart-button mt-3">
                                    <a href="<?php echo base_url('shop/') ?>" class="btn default-light-theme conti-button default-theme default-theme-2 rounded">LANJUT BELANJA</a>
        ...
        <div class="modal-content ">
            ...
            <div class="modal-body">
                ...
                <div class="modal-title">
                    <h2 class="tt-title">Daftar untuk Penawaran Terbaru Kami!!</h2>
                    <p class="font-light">Jangan sampai ketinggalan produk terbaru dari kami.</p>
                    <p class="font-light">Oh, dan ini Gratis!</p>
