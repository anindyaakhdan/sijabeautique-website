...
<!-- Mirrored from themes.pixelstrap.com/voxo/front-end/coming-soon.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Jan 2023 16:03:03 GMT -->
            ...
            <div class="row">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" id="store" viewBox="130 0 1230 930">
                                <defs>
                                    ...
                                    <g id="cat">
                                        ...
                                        <path fill="#FFF" stroke="#f4a9bc" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M1097.1 612.3c0 0-4.5-9.3-0.3-17.7 0 0 4.5 5.6 9.3 7" />
                                        <path fill="#FFF" stroke="#f4a9bc" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M1140.6 612.3c0 0 4.5-9.3 0.3-17.7 0 0-4.5 5.6-9.3 7" />
                                        <circle fill="#FFF" stroke="#f4a9bc" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" cx="1118.6" cy="621.7" r="23.1" />
                                        <path fill="#ED4F43" d="M1122.4 625c0 5.3-1.4 6.3-3.8 6.3 -2.4 0-3.8-1-3.8-6.3" />
                                        <path fill="#FFF" stroke="#f4a9bc" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M1132.8 621.2c0 3.9-3.2 7-7 7s-7-3.2-7-7h-0.2c0 3.9-3.2 7-7 7s-7-3.2-7-7" />
                                        <path fill="#FFF" stroke="#f4a9bc" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M1104.7 613c0 0 0-3.1 2.8-3.8 2.9-0.8 4.2 1.7 4.2 1.7" />
                                        <path fill="#FFF" stroke="#f4a9bc" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M1132.6 613c0 0 0-3.1-2.8-3.8 -2.9-0.8-4.2 1.7-4.2 1.7" />
                                    ...
                                    <g id="plane">
                                        ...
                                        <text transform="matrix(1.0027 0 0 1 44.8218 224.8768)" font-family='Fredoka One' font-size="34" fill=""> We are building your store
                                        </text>
                                ...
                                <g id="browser">
                                    ...
                                    <path fill="none" stroke="#f4a9bc" class="stroke" d="M943.5 361.5H454.1c-5.5 0-9.9-4.5-9.9-9.9V344c0-5.5 4.5-9.9 9.9-9.9h489.4c5.5 0 9.9 4.5 9.9 9.9v7.6C953.4 357.1 949 361.5 943.5 361.5z" />
                ...
                <div class="col-sm-8 m-auto">
                    <div class="coming-soon-content">
                        <div>
                            <h1>Kami Akan Segera Datang</h1>
                            <p>kami selalu disini! jika kamu ingin mendapatkan info terbaru tentang kami, subscribe untuk mendapatkan email dari kami!</p>
                            <form>
                                <input class="form-control" placeholder="masukan alamat email">
                                <a href="index.html" class="btn btn-solid-default mt-4">Beritahu Aku!</a>
                            </form>
                        </div>
                    </div>
                </div>
